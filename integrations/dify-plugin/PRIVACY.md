...
This plugin does not collect, store, or transmit any personal data on its own. It acts as a pass-through layer between the Feishu Bridge gateway and Dify workflows.

## Data Flow

1. Feishu events are received by the Feishu Bridge Java gateway via WebSocket.
...
- **Feishu Bridge Gateway**: A self-hosted service you control. No external data sharing.
